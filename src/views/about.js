...
const About = (props) => {
  return (
    <div className="about-container">
      <Helmet>
        <title>About - Youni</title>
        <meta property="og:title" content="About - Youni" />
      </Helmet>
      <header
        data-thq="thq-navbar"
        className="about-navbar-interactive Heading navbar-style"
      >
        <div className="about-container1">
          <img alt="image" src="/logo-200h.png" className="about-image" />
        </div>
        <div data-thq="thq-navbar-nav" className="about-desktop-menu">
          <nav className="about-links">
            <span className="about-text">About</span>
            <span className="about-text1">Features</span>
            <span className="about-text2">Faq</span>
            <span className="about-text3">Member</span>
          </nav>
          <div className="about-buttons">
            <button className="about-login button download-style">
              Download IOS
            </button>
            <button className="button download-style about-register">
              Download Android
            </button>
          </div>
        </div>
        ...
        <div data-thq="thq-mobile-menu" className="about-mobile-menu">
          <div className="about-nav">
            ...
            <nav className="about-links1">
              <span className="about-text4">About</span>
              <span className="about-text5">Features</span>
              <span className="about-text6">Pricing</span>
              <span className="about-text7">Team</span>
              <span className="about-text8">Blog</span>
            </nav>
      ...
      <div className="about-yellow">
        <img
          alt="image"
          src="/ellipse%20yellow1.svg"
          className="about-image1"
        />
      </div>
      <div className="about-pink">
        <img alt="image" src="/ellipse%20pink.svg" className="about-image2" />
      </div>
    </div>
  )
}
